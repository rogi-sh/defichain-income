...
export class Changelog {
  ...
  constructor() {
    ...
    this.log = new Log();
    this.log.version = '10.2.11 - 22.8.2023';
    this.log.comment = 'new tokens in crypto pools area';
    this.logs.push(this.log);

    this.log = new Log();
    this.log.version = '10.2.10 - 23.7.2023';
    this.log.comment = 'dd correct dfx link for buy crypto';
    this.logs.push(this.log);
    ...
    this.log = new Log();
    this.log.version = '10.2.7 - 7.3.2023';
    this.log.comment = 'new tokens to dex';
    this.logs.push(this.log);

    this.log = new Log();
    this.log.version = '10.2.6 - 2.3.2023';
    this.log.comment = 'move income server';
    this.logs.push(this.log);

    this.log = new Log();
    this.log.version = '10.2.5 - 3.2.2023';
    this.log.comment = 'Switch back to official ocean';
    this.logs.push(this.log);

    this.log = new Log();
    this.log.version = '10.2.4 - 3.2.2023';
    this.log.comment = 'Switch back to ocean of income';
    this.logs.push(this.log);
    ...
    this.log = new Log();
    this.log.version = '10.0.1 - 17.1.2023';
    this.log.comment = 'Fix share of pool tokens not correct';
    this.logs.push(this.log);

    this.log = new Log();
    this.log.version = '10.0.0 - 17.1.2023';
    ...
    this.log = new Log();
    this.log.version = '9.10.2 - 16.11.2022';
    this.log.comment = 'Fix dfi in Lock staking during refresh';
    this.logs.push(this.log);
    ...
    this.log = new Log();
    this.log.version = '9.9.1 - 9.10.2022';
    this.log.comment = 'add new dTokens dWmt, dUl, dUng, dUso in backend interaction';
    this.logs.push(this.log);
    ...
    this.log = new Log();
    this.log.version = '9.5.2 - 12.8.2022';
    this.log.comment = 'New Pools in total value';
    this.logs.push(this.log);

    this.log = new Log();
    this.log.version = '9.5.1 - 12.8.2022';
    this.log.comment = 'Added new pool to calculations, andjusting pool rewards for stable pools';
    this.logs.push(this.log);

    this.log = new Log();
    this.log.version = '9.5.0 - 5.8.2022';
    this.log.comment = 'Adjusted stable coin pools rewards, added new pools jnj, addyy, gs and dax for dex and history view';
    this.logs.push(this.log);

    this.log = new Log();
    this.log.version = '9.4.1 - 1.8.2022';
    this.log.comment = 'Adjusted old pool rewards because of new pools.';
    this.logs.push(this.log);
