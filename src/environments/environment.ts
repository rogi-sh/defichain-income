...
export const environment = {
  production: false,
  prices: 'https://ocean.defichain.com/v0/mainnet/prices?size=1000',
  oraclePrices: 'https://ocean.defichain.com/v0/mainnet/loans/tokens?size=1000',
  poolpairsocean: 'https://ocean.defichain.com/v0/mainnet/poolpairs?size=1000',
  ...
  account_tokens: 'https://ocean.defichain.com/v0/mainnet/address/ADDRESS/tokens?size=1000',
  account_balance: 'https://ocean.defichain.com/v0/mainnet/address/ADDRESS/balance?size=1000',
  address_vaults: 'https://ocean.defichain.com/v0/mainnet/address/ADDRESS_VAULTS/vaults?size=1000',
